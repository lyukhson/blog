...
AI 기반 의료기기의 지속적인 관리의 일환으로, 제조업체는 기기 성능 변화뿐만 아니라 기기 성능 변화로 이어질 수 있는 기기 입력값 및 기기 사용 환경의 변화를 사전에 모니터링하고, 식별하고, 해결해야 합니다. 또한 제조업체는 품질 시스템 규정(21 CFR Part 820)에 따라 AI 기반 의료기기의 바람직하지 않은 성능 변화와 관련된 위험을 관리하기 위해 포괄적인 위험 분석 프로그램 및 문서화 계획을 개발하고 실행해야 합니다. 이러한 규정에는 경영 책임(21 CFR 820.20), 설계 검증(21 CFR 820.30(g)), 설계 변경(21 CFR 820.30(i)), 부적합 제품(21 CFR 820.90), 시정 및 예방 조치(21 CFR 820.100)가 포함되지만 이에 국한되지 않습니다. 또한 제조업체는 21 CFR Parts 803 및 806에 따라 기기 성능을 모니터링하고 사망, 중상해 및 오작동에 대한 정보를 FDA에 보고해야 합니다.
...
*제조업체가 제출 시 포함해야 할 사항:* 제조업체는 특정 제출에 대한 제출 규정을 준수해야 합니다. 또한 제조업체는 관련 시판 허가 제출 유형에 대한 FDA 권장사항을 고려해야 합니다. 제조업체는 또한 환자 식별자, 영업 비밀 및 기밀 상업 정보를 제외하고 다음 유형의 정보를 제공해야 합니다:
...
본 지침의 섹션 V–XIII는 AI 기반 의료기기에 대한 시판 허가 제출 시 포함될 수 있는 문서에 관한 권장사항을 제공합니다. 아래 표는 논의된 문서를 제공하기 위한 시판 허가 제출 내 권장 위치를 요약한 것입니다. 이 문서를 제출할 수 있는 한 가지 방법은 eSTAR 프로그램을 통하는 것입니다. 구체적으로, eSTAR은 신청자가 포괄적인 의료기기 제출을 준비하는 과정을 안내하는 대화형 PDF 양식입니다. eSTAR은 무료이며 면제되지 않는 한 모든 510(k) 제출에 필수입니다.
...
**부록 E: 모델 카드 예시**\
모델 카드는 FDA가 요구할 수 있는 정보의 종류와 일치할 수 있는 기기에 대한 정보를 전달하기 위한 인기 있는 형식입니다. 예를 들어 공개적으로 이용 가능한 510(k) 요약 및 라벨링에서 그러합니다. 아래에서 논의되는 모델 카드 형식과 내용은 제조업체가 공개 제출 요약 및 이 정보가 제조업체에 의해 공유될 수 있는 다른 위치에서 모델 및 AI 기반 의료기기에 대한 정보를 전달하는 데 사용할 수 있는 가능한 형식의 예로 제공되기 위한 것입니다. FDA가 모델 카드 또는 특정 모델 카드 형식의 포함을 요구하지 않으며, 이 예시는 템플릿으로 간주되어서는 안 된다는 점에 유의하는 것이 중요합니다. 아래의 예시 모델 카드는 비기술적 청중이 유용하고 이해하기 쉬운 순서와 형식으로 데이터를 제시하기 위해 사용자 중심 연구를 기반으로 설계되었으며, 모델 카드의 포함을 촉진하기 위해 제조업체에게 제공됩니다.
